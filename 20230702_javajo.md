...
- Java8 まで
  ...
  - 1.x と言っていた時代があった。
    ...
    - 1.4 → 5 にバージョンが上がった時に、拡張 for 文に現場が沸いた。
...
- Java の歴史
  ...
  - [Java の基本知識の解答続き](https://gakumon.tech/java/java_knowledge_answer_3.html)
  - [2022 年の Java まるわかり！最新バージョンから Java を取り巻く環境まで](https://gihyo.jp/article/2022/07/java2022-0701)
...
- JShell
  ...
  - [JShell の概要」](https://docs.oracle.com/javase/jp/9/jshell/introduction-jshell.htm)
